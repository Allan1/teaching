...
CREATE TABLE IF NOT EXISTS `teaching`.`users` (
  ...
  `last_seen` DATETIME NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `teaching`.`professors` (
  `user_id` INT NOT NULL COMMENT '',
  `document` VARCHAR(45) NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `teaching`.`studentclasses` (
  ...
  `school_id` INT NOT NULL COMMENT '',
  `professor_user_id` INT NULL COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '',
  INDEX `fk_studentclasses_schools1_idx` (`school_id` ASC)  COMMENT '',
  INDEX `fk_studentclasses_professors1_idx` (`professor_user_id` ASC)  COMMENT '')
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `teaching`.`students_has_stages` (
  ...
  `student_user_id` INT NOT NULL COMMENT '',
  PRIMARY KEY (`stage_id`, `student_user_id`)  COMMENT '',
  INDEX `fk_students_has_stages_stages1_idx` (`stage_id` ASC)  COMMENT '',
  INDEX `fk_students_has_stages_students1_idx` (`student_user_id` ASC)  COMMENT '')
ENGINE = InnoDB;
