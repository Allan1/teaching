...
CREATE TABLE IF NOT EXISTS `teaching`.`students` (
  ...
  `studentclasse_id` INT NULL COMMENT '',
  `user_id` INT NOT NULL COMMENT '',
  `school_id` INT NOT NULL COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `teaching`.`stages` (
  ...
  PRIMARY KEY (`id`)  COMMENT '',
  INDEX `fk_stages_sections1_idx` (`section_id` ASC)  COMMENT '',
...
-- -----------------------------------------------------
-- Table `teaching`.`stagespages`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `teaching`.`stagespages` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `number` INT NOT NULL COMMENT '',
  `title` VARCHAR(45) NOT NULL COMMENT '',
  `stage_id` INT NOT NULL COMMENT '',
  `text` TINYTEXT NULL COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '',
  INDEX `fk_stagespages_stages1_idx` (`stage_id` ASC)  COMMENT '',
  CONSTRAINT `fk_stagespages_stages1`
    FOREIGN KEY (`stage_id`)
    REFERENCES `teaching`.`stages` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `teaching`.`answers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `teaching`.`answers` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `name` VARCHAR(45) NOT NULL COMMENT '',
  ...
  CONSTRAINT `fk_answers_questions1`
    ...
    REFERENCES `teaching`.`questions` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `teaching`.`questions` (
  ...
  PRIMARY KEY (`id`)  COMMENT '',
  INDEX `fk_questions_stages1_idx` (`stage_id` ASC)  COMMENT '',
  INDEX `fk_questions_answers1_idx` (`answer_id` ASC)  COMMENT '',
  CONSTRAINT `fk_questions_stages1`
    FOREIGN KEY (`stage_id`)
    REFERENCES `teaching`.`stages` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_questions_answers1`
    ...
    REFERENCES `teaching`.`answers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
