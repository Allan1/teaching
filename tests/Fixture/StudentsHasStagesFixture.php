...
class StudentsHasStagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            ...
            'fk_students_has_stages_students1_idx' => ['type' => 'index', 'columns' => ['student_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['stage_id', 'student_id'], 'length' => []],
            'fk_students_has_stages_stages1' => ['type' => 'foreign', 'columns' => ['stage_id'], 'references' => ['stages', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_students_has_stages_students1' => ['type' => 'foreign', 'columns' => ['student_id'], 'references' => ['students', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
