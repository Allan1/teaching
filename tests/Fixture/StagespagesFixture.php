 ...
 *
 */
class StagespagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_stagespages_stages1_idx' => ['type' => 'index', 'columns' => ['stage_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_stagespages_stages1' => ['type' => 'foreign', 'columns' => ['stage_id'], 'references' => ['stages', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
