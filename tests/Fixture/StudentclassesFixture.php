...
class StudentclassesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'professor_user_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            'fk_studentclasses_schools1_idx' => ['type' => 'index', 'columns' => ['school_id'], 'length' => []],
            'fk_studentclasses_professors1_idx' => ['type' => 'index', 'columns' => ['professor_user_id'], 'length' => []],
        ],
        '_constraints' => [
